...
class shotgun:
    ...
    def __init__(cls, hostname: str, login: str, password: str):
        cls.hostname = hostname
        cls.login = login
        cls.password = password
        cls.sg = shotgun_api3.Shotgun(cls.hostname,
                                       login=cls.login,
                                       password=cls.password)

    def get_project(cls, project_name: str) -> Dict:
        ...
        """
        project = cls.sg.find_one('Project',
    ...
    def create_project(cls, project_name: str) -> Dict:
        ...
        return cls.sg.create('Project', data)

    def get_sequence(cls, project: Dict, seq_name: str) -> Dict:
        ...
        sFields = ['id', 'code']
        sgSeq = cls.sg.find_one('Sequence', sFilters, sFields)
        if sgSeq:
            return sgSeq
        else:
    ...
    def create_seq(cls, project: Dict, seq_name: str) -> Dict:
        ...
        return cls.sg.create('Sequence', data)

    def get_shot(cls, project: Dict, seq: Dict, shot_name: str) -> Dict:
        ...
        sFields = ['id', 'code']
        sgSeq = cls.sg.find_one('Shot', sFilters, sFields)
        if sgSeq:
            return sgSeq
        print('Could not find {0} Shot in SG'.format(shot_name))
        return None

    def create_shot(cls, project: Dict, seq: Dict, shot_name: str) -> Dict:
        ...
        return cls.sg.create('Shot', data)

    def get_version(cls, project: Dict, shot: Dict) -> Dict:
        ...
        sFields = ['id', 'code']
        sgSeq = cls.sg.find_one('Version', sFilters, sFields)
        if sgSeq:
            return sgSeq
    ...
    def create_version(
            cls, project: Dict, shot: Dict, version_nbr: int) -> Dict:
        ...
        return cls.sg.create('Version', data)

    def upload_movie(cls, version: Dict, movie_path: str) -> Dict:
        ...
        """
        return cls.sg.upload('Version', version['id'],
